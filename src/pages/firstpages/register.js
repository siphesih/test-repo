        ...
        <div className="row">
          <div className="col-12 col-md-6 bsb-tpl-bg-platinum">
            <div className="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
              ...
              <p className="mb-0">
                Not a member yet? 
                <a href="#!" className="link-secondary text-decoration-none">Register now</a>
              </p>
            </div>
          </div>
            ...
            <div className="p-3 p-md-4 p-xl-5">
              <div className="row">
                <div className="col-12">
                  <div className="mb-5">
                    <h2 className="h3">Complete Your Registration</h2>
              ...
              <div className="row">
                <div className="col-12">
                  ...
                  <p className="m-0 text-secondary text-end">
                    ...
                    <a href="#!" className="link-primary text-decoration-none">Sign in</a>
                  </p>
                </div>
              </div>
              <div className="row">
